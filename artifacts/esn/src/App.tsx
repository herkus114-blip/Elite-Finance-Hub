...
>
EIDB Elite Settlement Network Demo Access </h1>
...
function Router() {
return ( <MainLayout> <Switch> <Route path="/" component={Dashboard} /> <Route path="/assets" component={Assets} /> <Route path="/ai" component={AiIntelligence} /> <Route path="/treasury" component={Treasury} /> <Route path="/settlement" component={SettlementNetwork} /> <Route path="/deposits" component={Deposits} /> <Route path="/gateway" component={Gateway} /> <Route path="/demo" component={InvestorDemo} /> <Route component={NotFound} /> </Switch> </MainLayout>
);
}
...
return ( <QueryClientProvider client={queryClient}> <ThemeProvider defaultTheme="dark" storageKey="esn-theme"> <TooltipProvider>
<WouterRouter
